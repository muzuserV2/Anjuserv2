...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Jᴏꜱʜᴜᴠᴀ sᴇʀ' : process.env.OWNER_NAME,
    PHONE: process.env.NUMBER === undefined ? '+919605741366' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'Jᴏꜱʜᴜᴠᴀ sᴇʀ' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Jᴏꜱʜᴜᴠᴀ Sᴇʀ Bᴏᴛ' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Jᴏꜱʜᴜᴠᴀ Sᴇʀ Bᴏᴛ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Jᴏꜱʜᴜᴠᴀ Sᴇʀ Bᴏᴛ' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'Jᴏꜱʜᴜᴠᴀ Sᴇʀ Bᴏᴛ🎗️/💝/✨/📝' : process.env.CMD_LIST,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.!;]' : process.env.HANDLERS,
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Note this' : process.env.TAG_HEADER,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '919605741366,0,918281440156,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
